...
- **Head-on ram is mutual**: if you crash on the opponent's trail within 1 cell (Chebyshev) of their current head — i.e. inside the 3×3 zone around them — both cycles die at the ram point. Catches the case where the AI dodges one tick early by turning perpendicular, leaving the player to crash alone into the cell the AI just vacated.
